...
# Try and upstream this to sqlglot
def execute(
    sql: str | Expression,
    schema: t.Optional[t.Dict | Schema] = None,
    read: DialectType = None,
    tables: t.Optional[t.Dict] = None,
    custom_env: t.Optional[t.Dict] = None,
) -> Table:
    """
    ...
    # iterate over custom_env and uppercase all keys
    if custom_env:
        custom_env = {k.upper(): v for k, v in custom_env.items()}
