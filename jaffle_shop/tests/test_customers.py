...
# expected output
customers = [
    {'customer_id': 1, 'first_name': 'Alice',   'last_name': 'Henderson',   'first_order': '2020-01-01', 'most_recent_order': '2020-01-02', 'number_of_orders': 2, 'customer_lifetime_value': 200},
    {'customer_id': 2, 'first_name': 'Bob',     'last_name': 'Doe',         'first_order': '2020-01-01', 'most_recent_order': '2020-01-04', 'number_of_orders': 2, 'customer_lifetime_value': 300},
    {'customer_id': 3, 'first_name': 'Charlie', 'last_name': 'Krick',       'first_order': '2020-01-05', 'most_recent_order': '2020-01-05', 'number_of_orders': 1, 'customer_lifetime_value': 100},
    {'customer_id': 4, 'first_name': 'Dennis',  'last_name': 'Smith',       'first_order': None, 'most_recent_order': None,  'number_of_orders': None, 'customer_lifetime_value': None},
]
